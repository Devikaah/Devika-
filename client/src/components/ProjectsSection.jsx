...
const PROJECTS = [
  {
    ...
    sub: 'April 2026',
    col1img1: '/images/s2.png',
    col1img2: '/images/s4.png',
    col2img: '/images/sports-dashboard.png',
  ...
  },
  {
    ...
    sub: 'March 2026',
    col1img1: '/images/d2.png',
    col1img2: '/images/d3.png',
  ...
  sub: '2026',
  col1img1: '/images/n2.png',
  col1img2: '/images/n3.png',
  col2img: 'images/nifty50-dashboard.png.png',
  ...
  {
    num: '05',
    category: 'Data Analytics · Microsoft Excel',
    name: 'Coffee Shop Sales Dashboard',
    sub: 'September 2026',
    col1img1: '/images/c2.png',
    col1img2: '/images/c3.png',
    col2img: '/images/coffeeSales.png',
    github: 'https://github.com/Devikaah',
  },
  {
    num: '06',
    category: 'Machine Learning · Python + Gradio',
    name: 'Obesity Level Prediction',
    sub: 'June 2026',
    col1img1: '/images/ML2.png',
    col1img2: '/images/ml3.png',
    col2img: '/images/ml.png',
    github: 'https://github.com/Devikaah',
  },
];
  ...
  return (
    <section
      ...
      style={{
        background: '#0C0C0C',
        borderRadius:
          'clamp(30px, 5vw, 60px) clamp(30px, 5vw, 60px) 0 0',
        marginTop: 'clamp(-28px, -4vw, -56px)',
        position: 'relative',
        zIndex: 10,
        padding:
          'clamp(40px, 6vw, 80px) clamp(20px, 4vw, 40px) 0',
      }}
    >
      {/* Section Title */}
      <h2
