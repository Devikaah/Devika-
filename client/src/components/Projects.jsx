    ...
    <section id="projects" className="section">
      ...
      <style>{`
        ...
        .project-card::before {
          ...
          right: 0;
          height: 2px;
          background: linear-gradient(90deg, transparent, var(--proj-color), transparent);
          opacity: 0;
          transition: opacity 0.4s ease;
        }
        .project-card:hover::before { opacity: 1; }
        .project-card:hover {
          border-color: rgba(var(--proj-color), 0.3);
          box-shadow: 0 8px 60px rgba(0, 0, 0, 0.4), 0 0 40px rgba(0, 212, 255, 0.1);
        }
        .project-image-wrap {
          position: relative;
          height: 220px;
        ...
        .project-links .btn-outline svg,
        .project-links .btn-primary svg { width: 13px; height: 13px; }
      `}</style>
    </section>
  );
}
